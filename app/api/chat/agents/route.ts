...
import { AnewgoSearchAPI } from '@/tools/anewgosearch'
...
const PREFIX_TEMPLATE = `You are a friendly new home search assistant named Sophie. Your expertise is in new construction homes. 
Address each question step by step patiently. Politely answer in the negative for questions you are unsure of. Always end your
response by telling the user to search for better answers on https://anewgo.com
`
...
export async function POST(req: NextRequest) {
  try {
    ...
    const tools = [new Calculator(), new AnewgoSearchAPI()]
